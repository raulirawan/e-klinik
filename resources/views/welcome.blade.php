        ...
        <div class="st-hero-wrap st-color1 st-bg st-dynamic-bg overflow-hidden"
            ...
            <div class="st-hero st-style1 st-type1">
                <div class="container">
                    ...
                    <form method="GET" action="{{ route('check-available') }}" class="st-appointment-form"
                        id="appointment-form">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="st-form-field st-style1">
                                    <input name="date" type="text" id="datepicker" placeholder="dd/mm/yy">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#datepicker').datepicker({
                    ...
                    autoclose: true,
                    todayHighlight: true,
                    startDate: new Date() // Set the minimum allowed date to today
                });
            });
        </script>
    @endpush
