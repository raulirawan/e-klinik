...
<body>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <button data-id="{{ $work->dokter->id }}"
                                    data-nama_dokter="{{ $work->dokter->name }}"
                                    data-no_str="{{ $work->dokter->no_str }}"
                                    data-time="{{ $work->day_work }}"
    ...
    <!-- Start Footer -->
    <footer class="st-site-footer st-dynamic-bg" data-src="{{ asset('frontend') }}/assets/img/footer-bg.png">
